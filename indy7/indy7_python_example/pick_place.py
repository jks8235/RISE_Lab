...
class SingleIndy:
    ...
    def job_plan(self):
        ...
        self.indy7_task_pos = [
            [0.5, -0.3, 0.33, -0.001384742620016496, 179.94928598028307, 0.06657559817585178],
            [0.5, -0.3, 0.23, -0.001384742620016496, 179.94928598028307, 0.06657559817585178], # pick
            [0.5, -0.3, 0.33, -0.001384742620016496, 179.94928598028307, 0.06657559817585178],
            [0.5, -0.05, 0.33, -0.001384742620016496, 179.94928598028307, 0.06657559817585178],
            [0.5, 0.2, 0.33, -0.001384742620016496, 179.94928598028307, 0.06657559817585178],
            [0.5, 0.2, 0.23, -0.001384742620016496, 179.94928598028307, 0.06657559817585178], # place
            [0.5, 0.2, 0.33, -0.001384742620016496, 179.94928598028307, 0.06657559817585178]]
    ...
    def make_path(self,switch):
        ...
        if switch == 'joint':
            prog.add_move_home()
            for way_point in self.indy7_joint_pos:
                prog.add_joint_move_to(way_point, vel=self.vel, blend=self.j_blend)
            prog.add_move_home()
            prog.add_stop()
            ...
            for way_point in self.indy7_task_pos:
                print(way_point)
                prog.add_task_move_to(way_point, vel=self.vel, blend=self.t_blend)
