...
class VrepDistanceSensorBridge(object):
    def __init__(self, client, obj_handles, sensor_names):
        ...
        self.FOV_distance = [self.default_distance for i in range(7)]
        self.FOV_object_check = [0 for i in range(7)]
        self.sensor_pos = []
...
class VrepInterface(object):
    ...
    SENSOR_OBJ_NAMES = [
        "Proximity_sensor_1_Center",
        "Proximity_sensor_1_01",
        "Proximity_sensor_1_02",
        "Proximity_sensor_1_03",
        "Proximity_sensor_1_04",
        "Proximity_sensor_1_05",
        "Proximity_sensor_1_06",
        ]
...
def save_as_npy(data, name):
    path = '/media/jee/FC12-B7D8/data_folder/Sensor_Learning/data/hexagon_basic/learning_1/' + name + '.npy'
    np.save(path, data)
