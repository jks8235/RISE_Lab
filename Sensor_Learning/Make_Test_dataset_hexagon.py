...
class VrepDistanceSensorBridge(object):
    def __init__(self, client, obj_handles, sensor_names):
        ...
        self.sensor_pos_1 = []
        self.sensor_pos_2 = []
        self.sensor_pose_1 = [0 for i in range(19)]
        self.sensor_pose_2 = [0 for i in range(19)]
        ...
        # get transformation
        self.client.simxGetObjectPose(self.obj_handles[self.sensor_names[0]], -1, self.client.simxCreateSubscriber(self._proxi_sensor_pose_1_cb_1, dropMessages=True))
        self.client.simxGetObjectPose(self.obj_handles[self.sensor_names[1]], -1, self.client.simxCreateSubscriber(self._proxi_sensor_pose_1_cb_2, dropMessages=True))
        self.client.simxGetObjectPose(self.obj_handles[self.sensor_names[2]], -1, self.client.simxCreateSubscriber(self._proxi_sensor_pose_1_cb_3, dropMessages=True))
        self.client.simxGetObjectPose(self.obj_handles[self.sensor_names[3]], -1, self.client.simxCreateSubscriber(self._proxi_sensor_pose_1_cb_4, dropMessages=True))
        self.client.simxGetObjectPose(self.obj_handles[self.sensor_names[4]], -1, self.client.simxCreateSubscriber(self._proxi_sensor_pose_1_cb_5, dropMessages=True))
        self.client.simxGetObjectPose(self.obj_handles[self.sensor_names[5]], -1, self.client.simxCreateSubscriber(self._proxi_sensor_pose_1_cb_6, dropMessages=True))
        self.client.simxGetObjectPose(self.obj_handles[self.sensor_names[6]], -1, self.client.simxCreateSubscriber(self._proxi_sensor_pose_1_cb_7, dropMessages=True))
        self.client.simxGetObjectPose(self.obj_handles[self.sensor_names[7]], -1, self.client.simxCreateSubscriber(self._proxi_sensor_pose_1_cb_8, dropMessages=True))
        self.client.simxGetObjectPose(self.obj_handles[self.sensor_names[8]], -1, self.client.simxCreateSubscriber(self._proxi_sensor_pose_1_cb_9, dropMessages=True))
        self.client.simxGetObjectPose(self.obj_handles[self.sensor_names[9]], -1, self.client.simxCreateSubscriber(self._proxi_sensor_pose_1_cb_10, dropMessages=True))
        self.client.simxGetObjectPose(self.obj_handles[self.sensor_names[10]], -1, self.client.simxCreateSubscriber(self._proxi_sensor_pose_1_cb_11, dropMessages=True))
        self.client.simxGetObjectPose(self.obj_handles[self.sensor_names[11]], -1, self.client.simxCreateSubscriber(self._proxi_sensor_pose_1_cb_12, dropMessages=True))
        self.client.simxGetObjectPose(self.obj_handles[self.sensor_names[12]], -1, self.client.simxCreateSubscriber(self._proxi_sensor_pose_1_cb_13, dropMessages=True))
        self.client.simxGetObjectPose(self.obj_handles[self.sensor_names[13]], -1, self.client.simxCreateSubscriber(self._proxi_sensor_pose_1_cb_14, dropMessages=True))
        self.client.simxGetObjectPose(self.obj_handles[self.sensor_names[14]], -1, self.client.simxCreateSubscriber(self._proxi_sensor_pose_1_cb_15, dropMessages=True))
        self.client.simxGetObjectPose(self.obj_handles[self.sensor_names[15]], -1, self.client.simxCreateSubscriber(self._proxi_sensor_pose_1_cb_16, dropMessages=True))
        self.client.simxGetObjectPose(self.obj_handles[self.sensor_names[16]], -1, self.client.simxCreateSubscriber(self._proxi_sensor_pose_1_cb_17, dropMessages=True))
        self.client.simxGetObjectPose(self.obj_handles[self.sensor_names[17]], -1, self.client.simxCreateSubscriber(self._proxi_sensor_pose_1_cb_18, dropMessages=True))
        self.client.simxGetObjectPose(self.obj_handles[self.sensor_names[18]], -1, self.client.simxCreateSubscriber(self._proxi_sensor_pose_1_cb_19, dropMessages=True))

        self.client.simxGetObjectPose(self.obj_handles[self.sensor_names[19]], -1, self.client.simxCreateSubscriber(self._proxi_sensor_pose_2_cb_1, dropMessages=True))
        self.client.simxGetObjectPose(self.obj_handles[self.sensor_names[20]], -1, self.client.simxCreateSubscriber(self._proxi_sensor_pose_2_cb_2, dropMessages=True))
        self.client.simxGetObjectPose(self.obj_handles[self.sensor_names[21]], -1, self.client.simxCreateSubscriber(self._proxi_sensor_pose_2_cb_3, dropMessages=True))
        self.client.simxGetObjectPose(self.obj_handles[self.sensor_names[22]], -1, self.client.simxCreateSubscriber(self._proxi_sensor_pose_2_cb_4, dropMessages=True))
        self.client.simxGetObjectPose(self.obj_handles[self.sensor_names[23]], -1, self.client.simxCreateSubscriber(self._proxi_sensor_pose_2_cb_5, dropMessages=True))
        self.client.simxGetObjectPose(self.obj_handles[self.sensor_names[24]], -1, self.client.simxCreateSubscriber(self._proxi_sensor_pose_2_cb_6, dropMessages=True))
        self.client.simxGetObjectPose(self.obj_handles[self.sensor_names[25]], -1, self.client.simxCreateSubscriber(self._proxi_sensor_pose_2_cb_7, dropMessages=True))
        self.client.simxGetObjectPose(self.obj_handles[self.sensor_names[26]], -1, self.client.simxCreateSubscriber(self._proxi_sensor_pose_2_cb_8, dropMessages=True))
        self.client.simxGetObjectPose(self.obj_handles[self.sensor_names[27]], -1, self.client.simxCreateSubscriber(self._proxi_sensor_pose_2_cb_9, dropMessages=True))
        self.client.simxGetObjectPose(self.obj_handles[self.sensor_names[28]], -1, self.client.simxCreateSubscriber(self._proxi_sensor_pose_2_cb_10, dropMessages=True))
        self.client.simxGetObjectPose(self.obj_handles[self.sensor_names[29]], -1, self.client.simxCreateSubscriber(self._proxi_sensor_pose_2_cb_11, dropMessages=True))
        self.client.simxGetObjectPose(self.obj_handles[self.sensor_names[30]], -1, self.client.simxCreateSubscriber(self._proxi_sensor_pose_2_cb_12, dropMessages=True))
        self.client.simxGetObjectPose(self.obj_handles[self.sensor_names[31]], -1, self.client.simxCreateSubscriber(self._proxi_sensor_pose_2_cb_13, dropMessages=True))
        self.client.simxGetObjectPose(self.obj_handles[self.sensor_names[32]], -1, self.client.simxCreateSubscriber(self._proxi_sensor_pose_2_cb_14, dropMessages=True))
        self.client.simxGetObjectPose(self.obj_handles[self.sensor_names[33]], -1, self.client.simxCreateSubscriber(self._proxi_sensor_pose_2_cb_15, dropMessages=True))
        self.client.simxGetObjectPose(self.obj_handles[self.sensor_names[34]], -1, self.client.simxCreateSubscriber(self._proxi_sensor_pose_2_cb_16, dropMessages=True))
        self.client.simxGetObjectPose(self.obj_handles[self.sensor_names[35]], -1, self.client.simxCreateSubscriber(self._proxi_sensor_pose_2_cb_17, dropMessages=True))
        self.client.simxGetObjectPose(self.obj_handles[self.sensor_names[36]], -1, self.client.simxCreateSubscriber(self._proxi_sensor_pose_2_cb_18, dropMessages=True))
        self.client.simxGetObjectPose(self.obj_handles[self.sensor_names[37]], -1, self.client.simxCreateSubscriber(self._proxi_sensor_pose_2_cb_19, dropMessages=True))
...
# Proxi Sensor Transformation Call Back 1
    def _proxi_sensor_pose_1_cb_1(self, msg):
        self.sensor_pose_1[0] = msg[1]

    def _proxi_sensor_pose_1_cb_2(self, msg):
        self.sensor_pose_1[1] = msg[1]

    def _proxi_sensor_pose_1_cb_3(self, msg):
        self.sensor_pose_1[2] = msg[1]

    def _proxi_sensor_pose_1_cb_4(self, msg):
        self.sensor_pose_1[3] = msg[1]

    def _proxi_sensor_pose_1_cb_5(self, msg):
        self.sensor_pose_1[4] = msg[1]

    def _proxi_sensor_pose_1_cb_6(self, msg):
        self.sensor_pose_1[5] = msg[1]

    def _proxi_sensor_pose_1_cb_7(self, msg):
        self.sensor_pose_1[6] = msg[1]

    def _proxi_sensor_pose_1_cb_8(self, msg):
        self.sensor_pose_1[7] = msg[1]

    def _proxi_sensor_pose_1_cb_9(self, msg):
        self.sensor_pose_1[8] = msg[1]
    
    def _proxi_sensor_pose_1_cb_10(self, msg):
        self.sensor_pose_1[9] = msg[1]

    def _proxi_sensor_pose_1_cb_11(self, msg):
        self.sensor_pose_1[10] = msg[1]

    def _proxi_sensor_pose_1_cb_12(self, msg):
        self.sensor_pose_1[11] = msg[1]

    def _proxi_sensor_pose_1_cb_13(self, msg):
        self.sensor_pose_1[12] = msg[1]

    def _proxi_sensor_pose_1_cb_14(self, msg):
        self.sensor_pose_1[13] = msg[1]

    def _proxi_sensor_pose_1_cb_15(self, msg):
        self.sensor_pose_1[14] = msg[1]

    def _proxi_sensor_pose_1_cb_16(self, msg):
        self.sensor_pose_1[15] = msg[1]

    def _proxi_sensor_pose_1_cb_17(self, msg):
        self.sensor_pose_1[16] = msg[1]

    def _proxi_sensor_pose_1_cb_18(self, msg):
        self.sensor_pose_1[17] = msg[1]

    def _proxi_sensor_pose_1_cb_19(self, msg):
        self.sensor_pose_1[18] = msg[1]
    
# Proxi Sensor Transformation Call Back 1
    def _proxi_sensor_pose_2_cb_1(self, msg):
        self.sensor_pose_2[0] = msg[1]

    def _proxi_sensor_pose_2_cb_2(self, msg):
        self.sensor_pose_2[1] = msg[1]

    def _proxi_sensor_pose_2_cb_3(self, msg):
        self.sensor_pose_2[2] = msg[1]

    def _proxi_sensor_pose_2_cb_4(self, msg):
        self.sensor_pose_2[3] = msg[1]

    def _proxi_sensor_pose_2_cb_5(self, msg):
        self.sensor_pose_2[4] = msg[1]

    def _proxi_sensor_pose_2_cb_6(self, msg):
        self.sensor_pose_2[5] = msg[1]

    def _proxi_sensor_pose_2_cb_7(self, msg):
        self.sensor_pose_2[6] = msg[1]

    def _proxi_sensor_pose_2_cb_8(self, msg):
        self.sensor_pose_2[7] = msg[1]

    def _proxi_sensor_pose_2_cb_9(self, msg):
        self.sensor_pose_2[8] = msg[1]
    
    def _proxi_sensor_pose_2_cb_10(self, msg):
        self.sensor_pose_2[9] = msg[1]

    def _proxi_sensor_pose_2_cb_11(self, msg):
        self.sensor_pose_2[10] = msg[1]

    def _proxi_sensor_pose_2_cb_12(self, msg):
        self.sensor_pose_2[11] = msg[1]

    def _proxi_sensor_pose_2_cb_13(self, msg):
        self.sensor_pose_2[12] = msg[1]

    def _proxi_sensor_pose_2_cb_14(self, msg):
        self.sensor_pose_2[13] = msg[1]

    def _proxi_sensor_pose_2_cb_15(self, msg):
        self.sensor_pose_2[14] = msg[1]

    def _proxi_sensor_pose_2_cb_16(self, msg):
        self.sensor_pose_2[15] = msg[1]

    def _proxi_sensor_pose_2_cb_17(self, msg):
        self.sensor_pose_2[16] = msg[1]

    def _proxi_sensor_pose_2_cb_18(self, msg):
        self.sensor_pose_2[17] = msg[1]

    def _proxi_sensor_pose_2_cb_19(self, msg):
        self.sensor_pose_2[18] = msg[1]
...
#
    ...
    def simulation_step_done_cb(self, msg):
        ...
        sensor_pos_1 = self.FOV_distance_sensor.sensor_pose_1
        sensor_pos_2 = self.FOV_distance_sensor.sensor_pose_2
        ...
        if self.flag == False:
            ...
            self.pose_temp = self.pose_temp + [sensor_pos_1 + sensor_pos_2]
    ...
    def make_data(self):
        ...
        for i in range(len(self.input_data)-20):
            ...
            temp_pose = self.pose_data[(i+20)]

            # print(temp_output)

            self.test_input += [sum(temp_input, [])]
            self.test_output += [temp_output]
...
if __name__ == '__main__':
    ...
    for start_angle, end_angle in angle_path:
        ...
        input_data += copy.deepcopy(vrep.test_input)
        output_data += copy.deepcopy(vrep.test_output)
        pose_data += copy.deepcopy(vrep.test_pose)
        ...
        if count%10000 == 0:
            ...
            pose_np_data = pd.DataFrame(np.array(pose_data))

            # output_np_data = np.array(output_data)
            # pose_np_data = np.array(pose_data)

            # print("output : ", output_np_data.shape, type(output_np_data))
            # print("pose : ", pose_np_data.shape, type(pose_np_data))

            save_data_as_csv(input_np_data, 'input_Fold_%d'%(save_count))
            save_data_as_csv(output_np_data, 'output_Fold_%d'%(save_count))
            save_data_as_csv(pose_np_data, 'pose_Fold_%d'%(save_count))
