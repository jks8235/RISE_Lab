...
class MovegroupInterface(object):
    ...
    def pick_and_place(self):
        ...
        # ]
        way_points = [
            [0.55, 0.4, 0.45, -1.0, 0.0, 0.0, 0.0], # start
            [0.55, 0.4, 0.305, -1.0, 0.0, 0.0, 0.0], # pick
            [0.55, 0.4, 0.4, -1.0, 0.0, 0.0, 0.0], # up
            [0.55, 0.0, 0.4, -1.0, 0.0, 0.0, 0.0], # move
            [0.55, -0.4, 0.4, -1.0, 0.0, 0.0, 0.0], # place ready
            [0.55, -0.4, 0.305, -1.0, 0.0, 0.0, 0.0], # place
            [0.55, -0.4, 0.4, -1.0, 0.0, 0.0, 0.0], # up
            [0.55, 0.0, 0.4, -1.0, 0.0, 0.0, 0.0], # move back
            [0.55, 0.4, 0.4, -1.0, 0.0, 0.0, 0.0], # arrive
            [0.55, 0.4, 0.45, -1.0, 0.0, 0.0, 0.0] # end
