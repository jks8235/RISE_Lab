...
class PointCloud_Shape:
    ...
    def make_point(self):
        ...
        for point_num in range(self.points.shape[0]):
            ...
            distance = self.points[point_num, 0]
            
            if  self.points[point_num, 1] == 1:
...
def load_data(mode='test'):
    ...
    if mode == 'PAP_test':
        for i in range(1):
            path1 = '/media/jee/FC12-B7D8/data_folder/Sensor_Learning/data/sonar/PAP_test_1/total_output.npy'
            path2 = '/media/jee/FC12-B7D8/data_folder/Sensor_Learning/data/sonar/PAP_test_1/total_input.npy'
        ...
        for i in range(1):
            path1 = '/media/jee/FC12-B7D8/data_folder/Sensor_Learning_ver2/data/sonar/PAP_test_1/total_output.npy'
            path2 = '/media/jee/FC12-B7D8/data_folder/Sensor_Learning_ver2/data/sonar/PAP_test_1/total_input.npy'
